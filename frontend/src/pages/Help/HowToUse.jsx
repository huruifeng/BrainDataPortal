...
const GradientCard = ({ children, color = "primary", ...props }) => {
  return (
    <Card {...props} className={`gradient-card gradient-card--${color}`}>
...
const CodeBlock = ({ children }) => (
  <Paper elevation={4} className="code-block">
                    ...
                    <Grid container spacing={4} className="tech-stack-grid">
                      <Grid item xs={12} md={6}>
                        <GradientCard color="primary">
                          ...
                          <Typography variant="body1" className="tech-stack__description">
                            Modern React-based frontend with powerful visualization capabilities for complex biological
                            data.
                          </Typography>
                      ...
                      <Grid item xs={12} md={6}>
                        <GradientCard color="secondary">
                          ...
                          <Typography variant="body1" className="tech-stack__description">
                            High-performance Python backend optimized for bioinformatics and large-scale data
                            processing.
                          </Typography>
                          <Grid container spacing={1}>
                            {[
                              ...
                              { name: "Scanpy", desc: "Single-cell Analysis" },
                    ...
                    <Grid container spacing={3}>
                      ...
                      <Grid item xs={12} md={4}>
                        <FeatureCard
                          ...
                          description="Modern infrastructure with Docker, PostgreSQL, and Redis for scalable and reliable performance."
                          color="warning"
                        />
                      </Grid>
                    </Grid>
                ...
                <TabPanel value={value} index={1}>
                  <Container maxWidth="lg">
                    <Box className="section-header">
                      ...
                      <Typography variant="body1" color="text.secondary" className="section-description">
                        Follow these steps to set up your development environment and get BrainDataPortal running
                        locally.
                      </Typography>
                    </Box>
                          ...
                          <CardContent>
                            ...
                            <CodeBlock>
                              <div>
                                ...
                                <br />
                                git clone https://github.com/your-org/braindataportal.git
                                <br />
                                ...
                                <br />
                                <br />
                                <span className="comment"># Set up environment variables</span>
                                <br />
                                cp .env.example .env.local
                                <br />
                                <br />
                                <span className="comment"># Start development server</span>
                                <br />
                                npm run dev
                              </div>
                            </CodeBlock>
                      ...
                      <Grid item xs={12} md={6}>
                        <Card className="setup-card">
                          <CardContent>
                            ...
                            <CodeBlock>
                              <div>
                                <span className="comment"># Navigate to backend directory</span>
                                <br />
                                cd ../backend
                                <br />
                                <br />
                                <span className="comment"># Create virtual environment</span>
                                <br />
                                python -m venv venv
                                <br />
                ...
                <TabPanel value={value} index={2}>
                  <Container maxWidth="lg">
                    <Box className="section-header">
                      ...
                      <Typography variant="body1" color="text.secondary" className="section-description">
                        Learn about supported data formats and how to prepare your datasets for analysis in
                        BrainDataPortal.
                      </Typography>
                    </Box>
                    ...
                    <Grid container spacing={4} className="data-formats-grid">
                      ...
                      <Grid item xs={12} md={6}>
                        <GradientCard color="success">
                          ...
                          <List className="data-format__list">
                            {[
                              "H5AD with spatial coordinates",
                              "Visium data (10x Genomics)",
                              "MERFISH data",
                              "seqFISH data",
                    ...
                    <Alert severity="success" icon={<CheckCircle color="success" />} className="requirements-alert">
                      <AlertTitle className="alert-title">Expression Matrix Requirements</AlertTitle>
                      <List dense>
                        <ListItem>
                          <ListItemText primary="Genes as rows, cells as columns (or vice versa with proper annotation)" />
                        </ListItem>
                        <ListItem>
                          <ListItemText primary="Unique gene identifiers (Ensembl IDs or gene symbols)" />
                        </ListItem>
                        <ListItem>
                    ...
                    <Grid container spacing={3} className="format-examples-grid">
                      <Grid item xs={12} md={6}>
                        <Card className="format-card">
                          <CardContent>
                            <Typography variant="h6" className="format-title format-title--primary">
                              Metadata Format (CSV)
                            </Typography>
                      ...
                      <Grid item xs={12} md={6}>
                        <Card className="format-card">
                          <CardContent>
                            <Typography variant="h6" className="format-title format-title--secondary">
                              Features Format (CSV)
                            </Typography>
                ...
                <TabPanel value={value} index={3}>
                  <Container maxWidth="lg">
                    <Box className="section-header">
                      ...
                      <Typography variant="body1" color="text.secondary" className="section-description">
                        Complete guide to using BrainDataPortal for data analysis and visualization of single-cell and
                    ...
                    <Grid container spacing={3} className="getting-started-grid">
                      <Grid item xs={12} md={6}>
                        <Card className="getting-started-card getting-started-card--primary">
                          <CardContent className="getting-started-content">
                            <Box className="getting-started-icon getting-started-icon--primary">
                            ...
                            >
                              Navigate to the "Upload" section and select your prepared dataset files.
                            </Typography>
                      ...
                      <Grid item xs={12} md={6}>
                        <Card className="getting-started-card getting-started-card--secondary">
                          <CardContent className="getting-started-content">
                            <Box className="getting-started-icon getting-started-icon--secondary">
                      ...
                      <CardContent className="workflow-content">
                        ...
                        <Box className="workflow-steps">
                          {[
                            ...
                            <Box key={i} className="workflow-step">
                              <Box className="workflow-step__number">{item.step}</Box>
                              <Box>
                                <Typography variant="subtitle1" fontWeight="bold">
                                  {item.title}
                                </Typography>
                                <Typography variant="body2" className="workflow-step__description">
                                  {item.desc}
                                </Typography>
                              </Box>
                            </Box>
