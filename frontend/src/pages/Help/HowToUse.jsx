                                    ...
                                    <Container maxWidth="lg">
                                        <Box className="section-header">
                                            ...
                                            <Typography variant="body1" color="text.secondary"
                                                ...
                                                BrainDataPortal is built with modern technologies to provide a powerful
                                            ...
                                            <Grid item xs={12} md={6}>
                                                <GradientCard color="primary">
                                                    ...
                                                    <Typography variant="body1" className="tech-stack__description">
                                                        ...
                                                        capabilities for complex biological
                                                        data.
                                                    </Typography>
                                    ...
                                    <Container maxWidth="lg">
                                        <Box className="section-header">
                                            ...
                                            <Typography variant="body1" color="text.secondary"
                                                ...
                                                BrainDataPortal running
                                                locally.
                                            </Typography>
                                        </Box>

                                        <Alert severity="info" icon={<Info color="info"/>}
                                               className="prerequisites-alert">
