        ...
        <div className="docs-container">
            <header className="docs-header">
                <div className="container">
                    ...
                    <h1>Visium Spatial Transcriptomics Data Preparation</h1>
                    <p className="subtitle">Step-by-step guide for preparing Visium Spatial Transcriptomics data for visualization in BrainDataPortal</p>
                </div>
            </header>
