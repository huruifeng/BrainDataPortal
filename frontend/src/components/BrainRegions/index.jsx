...
const BrainRegions = () => {
  ...
  const regions = {
    default_outer: {name: "Default", image: brainRegions.default_outer, assays: ["Assay 1", "Assay 2", "Assay 3"],},
    ...
    default_inner: {name: "Default", image: brainRegions.default_inner, assays: ["Assay 1", "Assay 2", "Assay 3"],},
