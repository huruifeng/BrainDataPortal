import {Box, Typography, Link, Paper, Card, CardContent, Button} from "@mui/material";
                    ...
                    {stats.map((stat, index) => (
                        <Grid2 item xs={12} sm={6} md={3} key={index} className="stat-item">
                            <Box elevation={2} sx={{textAlign: "center", px: 2, py: 0}}>
                                ...
                                <Typography variant="h5" component="div" gutterBottom color="primary"><Link
                                    href={stat.link} underline="none">{stat.value}</Link></Typography>
