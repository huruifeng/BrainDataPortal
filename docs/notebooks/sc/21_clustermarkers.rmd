---
title: "Cell Type Marker Analysis"
author: "Ruifeng Hu"
date: "`r Sys.Date()`"
output:
  html_document:
...
This notebook performs cell type marker analysis on a Seurat object, including:
- Finding cell type specific markers
- Calculating differential expression within cell types
...
```{r parameters}
seurat_obj_file <- "docs/notebooks/sc/example_data/pmdbs_lee_obj_updated_SN.rds" # Path to your Seurat object file
