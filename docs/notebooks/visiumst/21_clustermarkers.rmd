...
This notebook performs cluster marker analysis on a Seurat object, including:
- Finding cluster specific markers
- Calculating differential expression within clusters
...
```{r parameters}
seurat_obj_file <- "example_data/PD5D_MTG_10samples.rds" # Path to your Seurat object file
